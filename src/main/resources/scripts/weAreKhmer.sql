...
VALUES
    ('john_doe', 'john.doe@gmail.com', 'password123', NULL, '1990-01-01', true, false, 'male'),
...
insert into user_tb (email, password, gender) values ('dara1@gmail.com', '123', 'female');


select * from user_tb where email = 'dara@gmail.com';
select *, ut.username as myUserName from user_tb ut where email = 'victoria@gmail.com';

-- select uesr by email
select  ut.username, ut.email, ut.gender from user_tb ut where email = 'ethan@example.com';
...
INSERT INTO role_tb (name) VALUES ('ROLE_USER');
INSERT INTO role_tb (name) VALUES ('ROLE_AUTHOR');
...
alter table user_role_tb add constraint unique_user_id_fk unique (user_id, role_id);

INSERT INTO user_role_tb(user_id, role_id) VALUES ('3beb389a-2a88-47fa-8bbb-35a82d88f1cb', '677a67bd-686d-4298-b2a3-cdd0c729f155');
INSERT INTO user_role_tb(user_id, role_id) VALUES ('6035135d-7294-487d-8035-2d7befb94834', 'e50dfe6f-a928-4fa6-be70-508dc896a7ca');
...
-- get user by email
select * from user_tb where email = 'victoria@gmail.com';


select utb.user_id, utb.username, utb.email, rt.name as role_name from user_tb utb inner join user_role_tb urt on utb.user_id = urt.user_id
inner join role_tb rt on urt.role_id = rt.role_id where email = 'victoria@gmail.com';
...
-- *** this's not working
insert into user_role_tb (user_id, role_id) values ('6035135d-7294-487d-8035-2d7befb94834',(select role_id from role_tb where name = 'ROLE_AUTHOR')) returning user_id;
-- *** this's  working
insert into user_role_tb (user_id, role_id) values ((select user_id from user_tb where user_tb.user_id = '6035135d-7294-487d-8035-2d7befb94834'),(select role_id from role_tb where name = 'ROLE_AUTHOR')) returning user_id;

select * from user_tb where user_id = '6035135d-7294-487d-8035-2d7befb94834';

select * from user_tb where user_id = '6035135d-7294-487d-8035-2d7befb94834';
select utb.user_id, utb.username, utb.email, rt.name as role_name from user_tb utb inner join user_role_tb urt on utb.user_id = urt.user_id
                                                                                   inner join role_tb rt on urt.role_id = rt.role_id where urt.user_id = 'bcc760e8-f85d-43c7-8b41-ecc8748b027d';
...
create trigger assign_role_user_to_normal_user_trigger
    after insert on user_tb for each row execute procedure assign_role_user_to_normal_user();

select role_id from role_tb where name = 'ROLE_USER';
...
alter table category alter category_url set default null;


select * from category where category_id = '801c45f7-0d95-4dcf-b168-23713407058c';
insert into category(category_name) values ('temple');
